...
## <a name="what-account-can-i-use-to-sign-up-for-the-office-365-developer-program"></a>Quel compte puis-je utiliser pour m’inscrire au programme Office 365 pour les développeurs ?
...
## <a name="how-can-i-get-an-office-365-developer-subscription-via-the-developer-program"></a>Comment obtenir un abonnement Office 365 Développeur via le programme pour les développeurs ?  

Vous pouvez obtenir un abonnement Office 365 Développeur gratuit lorsque vous rejoignez le programme Office 365 Développeur. Cet abonnement spécial est conçu pour être utilisé uniquement pour le développement. Pour plus d’informations, reportez-vous à l’article [Configuration d’un abonnement Office 365 Développeur](office-365-developer-program-get-started.md).
...
Utilisez l’ID d’administrateur que vous avez créé lors de la configuration de votre abonnement développeur. Vous trouverez votre ID d’administrateur sur la vignette de l’abonnement sur le [tableau de bord du programme développeur](https://developer.microsoft.com/fr-FR/office/profile).
...
Pour plus d’informations sur les types d’activités que nous suivons, voir [Conditions d’utilisation de l’abonnement Office 365 Développeur](terms-and-conditions.md). 
...
## <a name="is-the-office-365-developer-program-available-in-my-language"></a>Le programme Office 365 Développeur est-il disponible dans ma langue ?
...
## <a name="is-the-office-365-developer-subscription-available-in-my-language"></a>L’abonnement Office 365 Développeur est-il disponible dans ma langue ?
