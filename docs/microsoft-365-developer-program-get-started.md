...
## <a name="instant-sandbox"></a>Bac à sable instantané
...
## <a name="configurable-sandbox"></a>Bac à sable configurable
...
2. Dans la boîte de dialogue **Configurer votre abonnement développeur Microsoft 365 E5**, choisissez si vous souhaitez un bac à sable instantané ou un bac à sable configurable, puis choisissez **Suivant**.
  ...
  ![Capture d’écran de la boîte de dialogue Configurer votre abonnement développeur Microsoft 365 E5](images/set-up-your-subscription.png)
...
## <a name="provision-microsoft-365-services-in-your-configurable-sandbox"></a>Provisionner des services Microsoft 365 dans votre bac à sable configurable
